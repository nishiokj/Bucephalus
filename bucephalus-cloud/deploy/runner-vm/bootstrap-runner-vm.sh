...
BUCEPHALUS_WORKER_ARCH=${BUCEPHALUS_WORKER_ARCH:-}
BUCEPHALUS_WORKER_CPU_COUNT=${BUCEPHALUS_WORKER_CPU_COUNT:-}
BUCEPHALUS_WORKER_MEMORY_MB=${BUCEPHALUS_WORKER_MEMORY_MB:-}
BUCEPHALUS_WORKER_DISK_MB=${BUCEPHALUS_WORKER_DISK_MB:-}
BUCEPHALUS_WORKER_ISOLATION=${BUCEPHALUS_WORKER_ISOLATION:-reusable_vm}
